    ...
    public class Plant_HealthTextPatch
    {
        ...
        public static void Postfix(Plant __instance)
        {
            ...
            if (BetterShow.isShow.Value)
            {
                ...
                String goldMagnetAttrackTextA = "冷却:";
                String goldMagnetAttrackTextB = "吸取:";
                ...
                switch (language)
                {
                    case "en-us":
                        ...
                        goldMagnetAttrackTextA = "Cool Down:";
                        goldMagnetAttrackTextB = "Attract:";
                        break;
                }
                ...
                if (__instance != null && __instance.thePlantType != null)
                {
                    switch (__instance.thePlantType)
                    {
                        case PlantType.GoldMagnet:
                            DisplayedString += '\n' + (__instance.theStatus == PlantStatus.GoldMagnet_attrack ? goldMagnetAttrackTextB : goldMagnetAttrackTextA) + __instance.attributeCountdown.ToString("0.0") + "s";
                            break;
